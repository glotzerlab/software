...
docker build $DIR/cuda8/bridges \
             ...
             -t glotzerlab/software:${DATE_TAG}-haswell-cuda8-hfi1-openmpi1.10.4
echo "BootStrap: docker
From: glotzerlab/software:${DATE_TAG}-haswell-cuda8-hfi1-openmpi1.10.4" > $DIR/cuda8/bridges/Singularity.bridges
